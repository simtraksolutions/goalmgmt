...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="modal fade" id="goalParametersModal" tabindex="-1" aria-labelledby="goalParametersModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-body">
              <form action="Untitled-1b.php" method="post">
                <div className="form-group">
                  ...
                  <input type="text" onChange={handleRenameOptionChange} name="Rename_Option" required />
                </div>
                <div className="form-group">
                  <label>Leads Generation:</label>
                  <input type="number" name="Leads_Generation" min="1" required />
                </div>
                <div className="form-group">
                  <label>Emails Sent:</label>
                  <input type="number" name="Emails_Sent" min="1" required />
                </div>
                <div className="form-group">
                  <label>Calls Made:</label>
                  <input type="number" name="Calls_Made" min="1" required />
                </div>
                <div className="form-group">
                  <label>Progressive Responses:</label>
                  <input type="number" name="Progressive_Responses" min="1" required />
                </div>
                <div className="form-group">
                  <label>Meetings Held:</label>
                  <input type="number" name="Meetings_Held" min="1" required />
                </div>
                <div className="form-group">
                  <label>WhatsApp Sent:</label>
                  <input type="number" name="WhatsApp_Sent" min="1" required />
                </div>
                <div className="form-group">
                  <label>Sessions Planned:</label>
                  <input type="number" name="Sessions_Planned" min="1" required />
                </div>
                <div className="form-group">
                  <label>Sessions Held:</label>
                  <input type="number" name="Sessions_Held" min="1" required />
                </div>
                <div className="form-group">
                  <label>Centres Planned:</label>
                  <input type="number" name="Centres_Planned" min="1" required />
                </div>
        ...
        <table class="table" style="width: 115%;">
          <thead>
            ...
            <?php while ($table = mysqli_fetch_object($results)) { ?>
              <tr>
                <th><a href="DB/access.php?team_id=1">#
                    <?php echo $table->id; ?>
                  </a></th>
                <th>
