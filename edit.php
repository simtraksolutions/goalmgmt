...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <!-- add member popup -->
      <div class="modal fade" id="deleteparameter" tabindex="-1" aria-labelledby="goalParametersModalLabel"
        aria-hidden="true">
      ...
      <!-- reorderparameter -->
      <!-- add member popup -->
      <div class="modal fade" id="reorderparameter" tabindex="-1" aria-labelledby="goalParametersModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
