                ...
                <div class="mobile-menu">
                  <nav id="dropdown">
                    <ul class="mobile-menu-nav">
                      <li><a data-toggle="collapse" data-target="#demo0" href="index.php">Dashboard<span
              ...
              <div style="margin-top:0px;margin-bottom:20px;" class="income-dashone-total shadow-reset nt-mg-b-30">
                <div class="income-title">
                  <div class="main-income-head">
                    <h2>Member List
                      <?php if ($_SESSION["role_id"] != 4) { ?><span style="float: right; margin-top: -7px;"><a
                            class="btn btn-primary" href="#"
                            onclick="window.open('addmember.php','Task Create','width=1500,height=400')">Add
                            Member</a></span>
                      <?php } ?>
                    </h2>
                    </h2>
                ...
                <div class="sparkline10-graph" style="overflow-x:scroll; overflow-y:hidden; border solid 0px;">
                        ...
                        <?php for ($j = 0; $j < count($role_array_id); $j++) { ?>
                          <?php if ($user_array_id[$i] == $role_array_id[$j]) { ?>
                            <tr>
                              ...
                              <td>
                                <?= $membertype[$user_role_id[$j]] ?>
                              </td>

                              <?php if ($_SESSION["role_id"] != 4) { ?>
                                <?php if ($_SESSION["role_id"] == 3 && $_SESSION['user_id'] == $user_array_id[$i]) {
                                  continue;
                                } ?>
                                <td><button
                                    onclick="confirmAction('<?= $user_array_id[$i] ?>','<?= $user_role_id[$j] ?>','<?= $teamID ?>')">Remove</button>
                                </td>
                              <?php } ?>
                            </tr>
                            <?php $sno++;
