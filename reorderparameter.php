...
<!doctype html>
<title>Reorder Paramenter | GOAL MANAGEMENT </title>
                  ...
                  <form id="uploadForm" enctype="multipart/form-data">
                    <div class="form-group-inner">
                      <div class="row">
                        ...
                        <div class="col-lg-9">
                          <select style="width:100%" class="select2_demo_3 form-control" name="before" id="new_value"
                            required="" tab-index="-1">
                            <?php $i = 0;
                    ...
                    <div class="form-group-inner">
                      <div class="row">
                        ...
                        <div class="col-lg-9">
                          <select style="width:100%" class="select2_demo_3 form-control" name="after" id="new_value"
                            required="" tab-index="-1">
                            <?php $i = 0;
                            foreach ($array as $value) { ?>
                              <?php if ($value != "Date" && $value != "Member Name") { ?>
