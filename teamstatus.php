                  ...
                  <form id="uploadForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group-inner">
                      <div class="form-group">
                        <input type="text" id="old_value" class="form-control" placeholder="Old Value"
                          value="<?= $table->Status ?>" readonly="">
                      </div>
                      <div class="form-group">
                        <select style="width:100%" class="select2_demo_3 form-control" name="team_activation"
                          id="new_value" required="" tab-index="-1">
                          <option value="Active" <?php if ($table->Status == "Active") {
                            echo "selected";
                          } ?>>Active
                          </option>
                          <option value="Inactive" <?php if ($table->Status == "Inactive") {
                            echo "selected";
                          } ?>>Inactive
                          </option>
                        </select>
