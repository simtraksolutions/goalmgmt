...
<!doctype html>
<title>Edit Team | GOAL MANAGEMENT </title>
                  ...
                  <form id="uploadForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group-inner">
                      <div class="row">
                        ...
                        <div class="col-lg-9">
                          <input type="text" value="<?= $teamid->team_name ?>" class="form-control" id="task_name"
                    ...
                    <div class="form-group-inner">
                      <div class="row">
                        ...
                        <div class="col-lg-9">
                          <input type="text" value="<?= $teamid->team_domain ?>" class="form-control" id="task_name"
                            name="team_domain" required>
                        </div>
                      </div>
                    </div>
                    <center>
