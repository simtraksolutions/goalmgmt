...
<div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
<?php if($_SESSION["role_id"] != 4){ ?><a href="#" onclick="window.open('monthgoal.php', 'newwindow', 'width=500,height=500'); return false;" class="dropdown-item">Month Goal</a><?php } ?> <a href="#" onclick="window.open('periousmonth.php', 'newwindow', 'width=500,height=500'); return false;" class="dropdown-item">Previous Months Goal</a></div>
</li>
...
<li><a data-toggle="collapse" data-target="#demo0" href="index.php">Home<span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
...
<li><a data-toggle="collapse" data-target="#demo1" href="#">Goal Management<span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
...
<h1><?php echo $_SESSION["team_name"]; ?><?php if($_SESSION["role_id"] != 4){ ?><span style="float: right; margin-top: -7px;"><a class="btn btn-primary" href="#" onclick="window.open('individualgoal.php','Task Create','width=1500,height=400')">Individual Goal</a></span><?php } ?></h1>
            ...
            <tr>
              ...
              <td>
                <?php if($_SESSION['role_id'] != 4){ ?>
                  ...
                  <?php } ?>
                  <a href="#" title="Review Goal" onclick="window.open('reviewgoal.php?delete_goal=<?=$table->ID?>', 'newwindow', 'width=500,height=500'); return false;" class="btn btn-success">R</a>
                  <a href="#" title="Delete Goal" onclick="window.open('deletegoal.php?delete_goal=<?=$table->ID?>', 'newwindow', 'width=500,height=500'); return false;" class="btn btn-primary">X</a>
                <?php }?>
              </td>
              <?php }?>
            </tr>
