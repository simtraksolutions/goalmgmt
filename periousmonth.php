  ...
  <div id="formbox">
      ...
      <div class="row">
          ...
          <div class="col-lg-9">
                <div class="chosen-select-single">
		            <select style="width:100%" class="select2_demo_3 form-control" data-placeholder="Select type" name="select_month" required>
    ...
    <div class="form-group-inner">
      <div class="row">
          ...
          <div class="col-lg-9">
                <div class="chosen-select-single">
		            <select style="width:100%" class="select2_demo_3 form-control" data-placeholder="Select type" name="select_year" required>
