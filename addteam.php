                            ...
                            <div class="col-lg-9">
                              <div class="chosen-select-single">
                                <select style="width:100%" class="select2_demo_3 form-control"
                                  data-placeholder="Select type" id="category" name="team_name"
                                  onchange="createNewInput()" aria-label="Default select example" required>
                                  <?php $i = 1;
                                  while ($table = mysqli_fetch_object($team_name)) {
