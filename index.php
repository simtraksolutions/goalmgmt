            ...
            <ul class="nav navbar-nav left-sidebar-menu-pro">
              <li class="nav-item">
                <a href="index.php" aria-expanded="false" class="nav-link" title="Dashboard"><i
                    ...
                    class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                ...
                <div class="mobile-menu">
                  <nav id="dropdown">
                    <ul class="mobile-menu-nav">
                      <li><a data-toggle="collapse" data-target="#demo0" href="#">Home<span
                    ...
                    <li><a data-toggle="collapse" data-target="#demo5"
                        href="https://adore.simtrak.in/signout.php">Logout<span
                          class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                    ...
                    <table width="100%" id="ssss" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php while ($table = mysqli_fetch_object($results)) { ?>
                          <tr>
                            <td style="width: 10%;"><a href="DB/access.php?team_id=<?= $table->id ?>">#
                                <?php echo $table->id; ?>
                              </a></td>
                            <td>
                              <?php echo $table->team_name; ?>
                            </td>
                            <td>
                              <?php echo $table->team_domain; ?>
                            </td>
                            <td>
                              <?php echo $table->team_manager; ?>
                            </td>
                            <td>
                              <?php echo $table->team_team_coordinator; ?>
                            </td>
                            <?php $ta = $table->Target_achiv;
                            $t = $table->Target;
                            $achivement = (float) ($table->Target_achiv / $table->Target) * 100;
                            $achivement = number_format($achivement, 2);
                            if ($achivement <= 25) { ?>
                              <td><span>
                                  <div class="pie animate no-round" style="--p:<?= $achivement ?>;--c:red;">
                                    <?= $achivement ?>%
                                  </div>
                                </span></td>
                            <?php } elseif ($achivement <= 50) { ?>
                              <td><span>
                                  <div class="pie animate no-round" style="--p:<?= $achivement ?>;--c:orange;">
                                    <?= $achivement ?>%
                                  </div>
                                </span></td>
                            <?php } elseif ($achivement <= 75) { ?>
                              <td><span>
                                  <div class="pie animate no-round" style="--p:<?= $achivement ?>;--c:yellow;">
                                    <?= $achivement ?>%
                                  </div>
                                </span></td>
                            <?php } else { ?>
                              <td><span>
                                  <div class="pie animate no-round" style="--p:<?= $achivement ?>;--c:green;">
                                    <?= $achivement ?>%
                                  </div>
                                </span></td>
                            <?php } ?>
                            <?php if ($_SESSION['role_id'] == 1) { ?>
                              <td>
                                <a href="#" <?php if ($table->Status == "Active") { ?> class="btn btn-primary" <?php } else { ?>
                                    class="btn btn-danger" <?php } ?> title="Change Team Status"
                                  onclick="window.open('teamstatus.php?team_id=<?= $table->id ?>', 'newwindow', 'width=500,height=500'); return false;"><i
                                    class='fa fa-gg-circle' aria-hidden='true'></i></a>
                                <a href="#" class="btn btn-primary" title="Change Team Name"
                                  onclick="window.open('editteam.php?team_id=<?= $table->id ?>', 'newwindow', 'width=500,height=500'); return false;"><i
